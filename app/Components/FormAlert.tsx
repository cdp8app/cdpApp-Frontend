...
const FormAlert: React.FC<FormAlertProps> = ({ message, type, duration = 0, onClose }) => {
  ...
  return (
    <div className={`relative mb-4 ${bgColor} ${textColor} rounded-md text-center flex items-center justify-between rounded-md px-5 py-5 text-sm shadow transition-all`}>

          ...
          <div className="flex w-[100%] flex-col items-center justify-center">
            ...
            {status === "success" && (
              <>
                ...
                <Link
                  href="/user/auth/login/forget-password/new-password"
          ...
          <div className="flex flex-col justify-center">
            ...
            {status === "error" && formError && (
              <div className="mb-[20px] mt-[30px] flex flex-row items-center justify-center">
                ...
                Oops! That was not right. Enter the correct code {formError}
                </p>
              </div>
            )}
            ...
            <form onSubmit={handleSubmit} className="">
              ...
              {status !== "success" && (
                <div className="flex flex-col justify-center mt-[30px]">
                  ...
                  <Link href={"/user/auth/login/forget-password"} className="flex justify-center">

...
export default function StudentApplications() {
  ...
  const filteredApplications = applications.filter((application) => {
    ...
    if (section === 2) return application.status === "accepted";
    if (section === 3) return application.status === "interview";
    if (section === 4) return application.status === "pending";
    if (section === 5) return application.status === "rejected";
    return false;
  });

...
export default function StudentSignUpForm() {
    ...
    return (
        <form className="flex flex-col justify-start ">
            <Label text="First Name" className="text-start" />
            <input placeholder="Input your First Name" className="border p-2 rounded-xl mb-[10px] outline-none border-black-300 font-serif font-black-900 placeholder-grey" />
            <Label text="Last Name" className="text-start" />
            <input placeholder="Input your Last Name" className="border p-2 rounded-xl mb-[10px] outline-none border-black-300 font-serif font-black-100 placeholder-grey" />
            ...
            <input placeholder="Phone Number" type="email" className="border p-2 rounded-xl mb-[10px] outline-none border-black-300 font-serif font-black-100 placeholder-grey" />

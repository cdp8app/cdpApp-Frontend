...
export default function CompanyJobsPosted() {
  ...
  const handleClick = () => {
    router.push("/company/dashboard/job/info");
  };
  return (
    <div>
        ...
        <div className="px-[4%]">
          ...
          {section === 1 && (
            <div className="mt-[20px]">
              ...
              <button className="bg-PriGold mt-[21px] justify-center flex flex-row items-center py-[20px] px-[170px] rounded-[999px] justify-self-center ">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"

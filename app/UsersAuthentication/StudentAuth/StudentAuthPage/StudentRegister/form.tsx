...
export default function StudentRegisterForm() {
    return (
        <form className="flex flex-col justify-start">
            <Label2 text="Email" className="text-Blue4 text-start font-sans text-[13px] font-medium " />
            ...
            <Label2 text="Password" className="text-Blue4 text-start font-sans text-[13px] font-medium" />
            <div className="flex flex-row width-[100%] items-center border-b-[2px] border-Blue3 px-[4.91px] py-[4.91px] mt-[8px]">
            ...
            <Label2 text="Password" className="text-Blue4 text-start font-sans text-[13px] font-medium" />
            <div className="flex flex-row width-[100%] items-center border-b-[2px] border-Blue3 px-[4.91px] py-[4.91px] mt-[8px] mb-[36px]">
                {/* <Image src={passwordIcon} alt="password" className="mr-[8px] w-[16px] h-[20px]" /> */}
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
